...
/* Insert Operation */ void insert(int val)
{
int i = ++size;
if (type == 1)  // MIN HEAP
{
...
/* Delete Operation */ void deleteRoot()
{
int last = heap[size--]; int parent = 1, child = 2;
if (type == 1)  // MIN HEAP
{
while (child <= size)
{
...
{
case 1:
printf("Enter value: "); scanf("%d", &val); insert(val);
break; case 2:
deleteRoot(); break;
case 3:
